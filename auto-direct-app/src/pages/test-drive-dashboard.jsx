          ...
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
            ...
            <div className="relative">
              ...
              <select
                ...
                className="pl-10 pr-8 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 appearance-none bg-white min-w-[160px]"
              >
                ...
                <div className="bg-gray-50 p-4 rounded-lg border">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div className="bg-blue-50 border border-blue-200 p-3 rounded">
                      <div className="text-blue-700 font-medium text-sm mb-1">Booking ID</div>
                      <div className="font-mono text-blue-900 text-xs break-all bg-white p-2 rounded border">
                        {selectedRequest.bookingID}
                      </div>
                    </div>
                    <div className="bg-green-50 border border-green-200 p-3 rounded">
                      <div className="text-green-700 font-medium text-sm mb-1">Vehicle ID</div>
                      <div className="font-mono text-green-900 text-xs break-all bg-white p-2 rounded border">
                        {selectedRequest.vehicleID}
                      </div>
                    </div>
                    <div className="bg-purple-50 border border-purple-200 p-3 rounded">
                      <div className="text-purple-700 font-medium text-sm mb-1">Customer ID</div>
                      <div className="font-mono text-purple-900 text-xs break-all bg-white p-2 rounded border">
                        {selectedRequest.userID}
                      </div>
                    </div>
                    {selectedRequest.dealerID && (
                      <div className="bg-orange-50 border border-orange-200 p-3 rounded">
                        <div className="text-orange-700 font-medium text-sm mb-1">Dealer ID</div>
                        <div className="font-mono text-orange-900 text-xs break-all bg-white p-2 rounded border">
                          {selectedRequest.dealerID}
                        </div>
                      </div>
                    )}
