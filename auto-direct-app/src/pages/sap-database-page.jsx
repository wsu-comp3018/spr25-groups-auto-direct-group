...
const SAPDatabasePage = () => {
  ...
  // Add function to send test emails
  const handleSendEmails = async () => {
    if (!orderFound || !selectedOrderID) {
      alert('Please search and verify an Order ID first');
      return;
    }
    ...
    try {
      console.log('🚀 Sending emails for order:', emailOrderData);
      ...
      if (response.ok) {
        alert(`✅ Emails sent successfully for Order ${selectedOrderID}!\n\nEmails sent to:\n- Customer: ${formData.email}\n- Data Entry Team\n- Logistics Team\n- Manufacturer`);
      } else {
          ...
          <div className="mt-8 pt-8 border-t border-gray-200">
            <div className="flex justify-center gap-4">
              ...
              <button
                ...
                disabled={!orderFound}
                className="bg-blue-600 text-white px-8 py-3 rounded-lg hover:bg-blue-700 disabled:bg-gray-300 disabled:text-gray-500 transition-colors font-semibold text-lg"
              >
                📧 Send Emails
              </button>
              <button
