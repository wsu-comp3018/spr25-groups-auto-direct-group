-- Add complaints table to autos-direct database
...
-- (`customer_name`, `customer_email`, `customer_phone`, `has_account`, `account_number`, `is_staff_related`, `staff_member`, `complaint_details`, `resolution_request`, `contact_details`, `status`) 
-- VALUES 
-- ('John Doe', 'john.doe@email.com', '0412345678', 'yes', 'ACC123456', 'no', NULL, 'Vehicle delivery was delayed by 2 weeks without proper communication.', 'I would like a discount on the final price and better communication about delivery status.', 'john.doe@email.com, 0412345678', 'pending');
